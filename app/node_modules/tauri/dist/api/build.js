...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/api/build.ts");
/******/ })
/************************************************************************/
/******/ ({
...
function resolvePath(basePath, dir) {
    return dir && path_1.isAbsolute(dir)
        ? dir
        : path_1.resolve(basePath, dir);
}
...
function findClosestOpenPort(port, host) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, isPortAvailable(port, host)
...
var getTauriConfig = function (cfg) {
    ...
    var pkg = non_webpack_require_1.default(pkgPath);
    ...
    if (!config_validator_1.isTauriConfig(config)) {
        var messages = config_validator_1.ajv.errorsText((_a = config_validator_1.isTauriConfig.errors) === null || _a === void 0 ? void 0 : _a.filter(function (e) { return e.keyword !== 'if'; }).map(function (e) {
    ...
    var runningDevServer = (_b = config.build.devPath) === null || _b === void 0 ? void 0 : _b.startsWith('http');
    if (!runningDevServer) {
...
var Runner = /** @class */ (function () {
                        ...
                        proxy_1.on('proxyRes', function (proxyRes, req, res) {
                            if (req.url === '/') {
                                ...
                                proxyRes.on('end', function () {
                                    ...
                                    self_1.__parseHtml(cfg, indexDir, false)
                                        .then(function (_a) {
                                        var html = _a.html;
                                        var headers = {};
                    ...
                    case 10:
                        ...
                        if (!this.tauriWatcher) {
                            ...
                            this.tauriWatcher = chokidar_1.default
                                ...
                                ignoreInitial: true,
                                ignored: [runningDevServer ? null : path_1.default.join(devPath, 'index.tauri.html')].concat(path_1.default.join(app_paths_1.tauriDir, 'target'))
                            })
                                .on('change', lodash_1.debounce(function (changedPath) {
                                if (_this.rewritingToml && changedPath.startsWith(path_1.default.join(app_paths_1.tauriDir, 'Cargo.toml'))) {
                                    return;
                                }
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        inlinedAssets = (_b.sent()).inlinedAssets;
                        process.env.TAURI_INLINED_ASSETS = inlinedAssets.join('|');
                        features = [
                                ...
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, this.__runCargoCommand({
                                            cargoArgs: __spreadArrays([
                                                ...
                                                '--features'
                                            ], features, (cfg.tauri.bundle.active && Array.isArray(cfg.tauri.bundle.targets) && cfg.tauri.bundle.targets.length
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, new Promise(function (resolve, reject) {
                                ...
                                var domInterceptor = cfg.tauri.embeddedServer.active ? undefined : function (dom) {
                                    var document = dom.window.document;
                                    if (!cfg.ctx.dev) {
    ...
    Runner.prototype.__whitelistApi = function (cfg, manifest) {
        var tomlFeatures = [];
        if (cfg.tauri.whitelist.all) {
            ...
            var whitelist = Object.keys(cfg.tauri.whitelist).filter(function (w) { return cfg.tauri.whitelist[String(w)]; });
            tomlFeatures.push.apply(tomlFeatures, whitelist.map(toKebabCase));
        }
...
exports.ajv = new ajv_1.default({ "allErrors": true, "coerceTypes": false, "format": "fast", "nullable": true, "unicode": true, "uniqueItems": true, "useDefaults": true });
